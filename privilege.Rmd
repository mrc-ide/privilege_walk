...
data_sorted$gender_ethnicity_no_na_reordered <- factor(data_sorted$gender_ethnicity_no_na , levels=c("Female Non white", "Female White", "Male Non white", "Male White"))
